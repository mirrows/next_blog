...
function LazyImage({ src, className, ...props }: TProps) {
    const loadingGif = useRef(process.env.NEXT_PUBLIC_LOADING_GIF || 'https://raw.githubusercontent.com/huaasto/empty/main/pub_lic/2023_06_09/pic1686281264582557.gif')
